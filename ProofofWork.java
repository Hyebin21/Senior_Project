...
public class ProofofWork {
        ...
        public static final int solve(byte[] sha256, int numberOfZerosInPrefix) {
            ...
            while ( x < Integer.MAX_VALUE) {
                ...
                // calculate new hash
                final byte[] result = HashUtils.calculateSha256(buffer.array()); //output
